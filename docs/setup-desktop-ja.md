...
Claude Desktop は Claude Code のGUIインターフェースを提供し、プラグイン・スキル・コマンド・MCPサーバー・CLAUDE.mdプロジェクト指示をフルサポートしています。本プラグインのほぼすべての機能が Desktop で利用可能です（Agent Teams のみCLI専用）。
